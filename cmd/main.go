...
func main() {
	...
	tempHistoryHandler.Info("Key New:  ", baseurl.Set("3_Url", "abrakada.com"))
	tempHistoryHandler.Info("Key New:  ", baseurl.Set("3_Url", "ab.com"))
	tempHistoryHandler.Info("ALL MAP:  ", baseurl)
	tempHistoryHandler.Info("Url: ", baseurl.Get("12_URL"))
	tempHistoryHandler.Info("Url: ", baseurl.Get("5_URL"))
	tempHistoryHandler.Info("number of keys: ", baseurl.Count())
}
